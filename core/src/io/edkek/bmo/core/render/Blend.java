...
public class Blend {
    ...
    @NotNull
    public static final Blend ADDITIVE = new Blend(GL20.GL_SRC_ALPHA, GL20.GL_ONE);
    @NotNull
    public static final Blend DEFAULT = new Blend(GL20.GL_SRC_ALPHA, GL20.GL_ONE_MINUS_SRC_ALPHA);
